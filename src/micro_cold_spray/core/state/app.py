"""State service FastAPI application."""

from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
from fastapi.routing import APIRouter

from micro_cold_spray.core.state.router import router, lifespan
from micro_cold_spray.core.base.router import add_health_endpoints

# Create FastAPI app with lifespan
app = FastAPI(
    title="State Service",
    description="Service for managing system state and monitoring",
    version="1.0.0",
    lifespan=lifespan
)
...
# Include state router without /api/v1 prefix
