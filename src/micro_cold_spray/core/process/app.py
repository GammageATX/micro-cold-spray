...
from micro_cold_spray.core.process.router import router, lifespan
from micro_cold_spray.core.base.router import add_health_endpoints

# Create FastAPI app with lifespan
app = FastAPI(
    title="Process Service",
    description="Service for managing process control and execution",
    version="1.0.0",
    lifespan=lifespan
)
...
# Include process router without /api/v1 prefix
