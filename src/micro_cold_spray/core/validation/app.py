...
from micro_cold_spray.core.validation.router import router, lifespan
from micro_cold_spray.core.base.router import add_health_endpoints

# Create FastAPI app with lifespan
app = FastAPI(
    title="Validation Service",
    description="Service for validating process parameters and configurations",
    version="1.0.0",
    lifespan=lifespan
)
...
# Include validation router without /api/v1 prefix
