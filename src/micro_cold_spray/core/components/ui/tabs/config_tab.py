...
class BackupManagerProtocol(Protocol):
    """Protocol for backup manager interface."""
...
class ConfigTab(BaseWidget):
    ...
    def _init_ui(self) -> None:
        ...
        # Add backup manager
        manager = BackupManager(self._ui_manager)
        self._backup_manager = cast(BackupManagerProtocol, manager)
        layout.addWidget(cast(QWidget, manager))
