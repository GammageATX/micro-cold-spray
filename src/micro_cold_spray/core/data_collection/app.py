...
from micro_cold_spray.core.data_collection.router import router, lifespan
from micro_cold_spray.core.base.router import add_health_endpoints

# Create FastAPI app with lifespan
app = FastAPI(
    title="Data Collection Service",
    description="Service for collecting and storing process data",
    version="1.0.0",
    lifespan=lifespan
)
...
# Include data collection router without /api/v1 prefix
