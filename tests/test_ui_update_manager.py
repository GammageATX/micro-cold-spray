...
class TestUIUpdateManager:
    ...
    async def test_ui_update_manager_initialization(self, ui_update_manager):
        ...
        assert len(ui_update_manager._registered_widgets) == 0
    ...
    async def test_widget_registration(self, ui_update_manager):
        ...
        assert ui_update_manager._registered_widgets[widget_id]["widget"] == widget
        assert ui_update_manager._registered_widgets[widget_id]["type"] == 'display'
        assert ui_update_manager._registered_widgets[widget_id]["location"] == 'motion'
        assert ui_update_manager._registered_widgets[widget_id]["tags"] == update_tags
    ...
    async def test_widget_cleanup_chain(self, ui_update_manager):
        ...
        assert "parent" not in ui_update_manager._registered_widgets
